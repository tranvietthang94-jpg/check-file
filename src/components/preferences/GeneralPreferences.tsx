  ...
  return (
    <div className="flex flex-col gap-6">
      <section className="flex flex-col gap-2">
        ...
        />
        <Checkbox
          label="Ngăn máy vào chế độ ngủ khi đang truyền"
      ...
      <section className="flex flex-col gap-1">
        ...
        <div className="flex gap-3 text-xs">
          {(["automatic", "manual"] as DateOverrideMode[]).map((m) => (
            <Radio
              ...
              label={m === "automatic" ? "Theo đồng hồ hệ thống" : "Đặt thủ công"}
            />
          ))}
        </div>
        ...
        {dateOverride.mode === "automatic" ? (
          <Checkbox
            label="Chuyển ngày lúc 4 giờ sáng (buổi quay đêm vẫn giữ ngày hôm trước)"
